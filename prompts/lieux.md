...
- **Place Jean Jaurès** : the main square of Castres. Its ground is bare paving with nothing built on it. Every building whose façade meets this square is classical, three storeys, pale rendered stone, and its GROUND FLOOR IS AN ARCADE OF ROUND STONE ARCHES running the full width of that building, arch after arch without interruption — never one arch at a corner and plain wall elsewhere; the shops and café terraces sit back under those arches. Which buildings face the square, how many there are, how long they are and what shape the square itself has: all of that is read from image 3, never invented. (Verified on Street View; two businesses are actually named after them.)
